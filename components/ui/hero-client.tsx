...
export const HeroClient = ({ userRole }: HeroClientProps) => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }}
          ...
          <Link href={userRole === 'user' ? '/user/reservar' : 'sign-in'} className="bg-brand-gradient text-cream font-body text-sm font-semibold tracking-widest uppercase px-10 py-4 rounded-sm hover:opacity-90 transition-opacity">
            Reservar Cita
          </Link>
